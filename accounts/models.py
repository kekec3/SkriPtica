...
class Korisnik(models.Model):
    ...
    idrol = models.ForeignKey(Role, models.DO_NOTHING, db_column='IdRol')  # Field name made lowercase.
    ...
    email = models.CharField(db_column='Email', max_length=18)  # Field name made lowercase.
